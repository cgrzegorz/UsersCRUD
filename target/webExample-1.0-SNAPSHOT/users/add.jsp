        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="${pageContext.request.contextPath}/users/list" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Wróć</a>
                </div>
                <!-- Page Heading -->
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" required name="userName" class="form-control" id="InputName" placeholder="Nazwa użytkownika">
                        </div>
                        <div class="mb-3">
                            <label for="InuptEmail" class="form-label">Email</label>
                            <input type="text" name="email" required class="form-control" id="InuptEmail" placeholder="Email użytkownika">
                        </div>
                        <div class="mb-3">
